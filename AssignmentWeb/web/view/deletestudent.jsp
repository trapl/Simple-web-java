                    ...
                    <form action="searchcourse" method="post">
                        <div class="search1">
                            ...
                            <select onchange="location = this.options[this.selectedIndex].value;">
                                ...
                                <option <c:if test="${requestScope.Type eq 'Course'}">selected</c:if> value="/AssignmentWeb/deleteteacher">Giáo viên</option>
                                </select></br>
                            </div>                      
                        </form>
                    </div>
                ...
                <section id="teach">
                    <div class="teach1">
                        ...
                        <c:forEach items="${requestScope.student}" var="h">
                            <tr>
                                ...
                                <td>${h.sdt}</td>
                                <td>${h.email}</td>
                                <td><a onclick="return confirmAction()" href="/AssignmentWeb/deletestudent?user=${h.ID}">Delete</a></td>
                            </tr>
                        </c:forEach>
                    </table>
                        <%
                  ...
                  List<Student> list = db.getallStudent();
                    ...
                    for (int i = 1; i <= numofpage; i++) {
                            ...
                            %>
                   <a href="deletestudent?start=<%=a %>&end=<%=b%>"><%=i%></a>
                   <%
                        }
                        %>
                </div>
